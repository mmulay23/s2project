"""
Django settings for s2api project.
...
SECRET_KEY = 'django-insecure-br84sxyg+f42sg7obzd6f&z8z8%r!b+%6m(pv6(y)ho^q82^t_'
...
WSGI_APPLICATION = 's2api.wsgi.application'
